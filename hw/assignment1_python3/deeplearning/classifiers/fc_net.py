...
class TwoLayerNet(object):
    ...
    def loss(self, X, y=None):
        ...
        ############################################################################
        out, cache_affine1 = affine_relu_forward(X, self.params['W1'], self.params['b1'])
